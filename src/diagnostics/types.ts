...
export const ERROR_CODES = [
    ...
    'WORKOUT_START_FAILED', 'WORKOUT_EQUIPMENT_LOAD_FAILED', 'WORKOUT_PAUSE_FAILED', 'WORKOUT_RESUME_FAILED',
    'WORKOUT_ACTIVE_SESSION_CONFLICT', 'WORKOUT_SET_SAVE_FAILED', 'WORKOUT_DUPLICATE_SET_BLOCKED',
    'WORKOUT_UNDO_FAILED', 'WORKOUT_EXERCISE_REPLACE_FAILED', 'WORKOUT_SET_PLAN_ADJUST_FAILED', 'WORKOUT_FINISH_FAILED', 'WORKOUT_ABANDON_FAILED', 'WORKOUT_RECOVERY_REPAIRED', 'WORKOUT_RECOVERY_BLOCKED',
    ...
    'ANDROID_UPDATE_CHECK_FAILED', 'ANDROID_UPDATE_DEFERRED', 'ANDROID_UPDATE_LAUNCH_FAILED', 'ANDROID_UPDATE_INSTALL_FAILED',
    'ANDROID_UPDATE_DOWNLOAD_FAILED', 'ANDROID_UPDATE_VERIFICATION_FAILED',
